...
class TestStringMethods(unittest.TestCase):
    ...
    def spore_connection_test(self, resolution, interval, delay, exp_len):
        ...
        times = (100.0, 200.0, 300.0, 400.0, 500.0, 600.0, 700.0, 800.0, 900.0, 1000.0, 1100.0, 1200.0, 1300.0, 1400.0,
                 1500.0, 1600.0, 1700.0, 1800.0, 1900.0, 2000.0, 2100.0, 2200.0, 2300.0, 2400.0, 2500.0, 2600.0, 2700.0,
                 2800.0, 2900.0, 3000.0, 3100.0, 3200.0, 3300.0, 3400.0, 3500.0, 3600.0, 3700.0, 3800.0, 3900.0, 4000.0,
                 4100.0, 4200.0, 4300.0, 4400.0, 4500.0, 4600.0, 4700.0, 4800.0, 4900.0, 5000.0, 5100.0, 5200.0, 5300.0,
                 5400.0, 5500.0, 5600.0, 5700.0, 5800.0, 5900.0, 6000.0, 6100.0, 6200.0, 6300.0, 6400.0, 6500.0, 6600.0,
                 6700.0, 6800.0, 6900.0, 7000.0, 7100.0, 7200.0, 7300.0, 7400.0, 7500.0, 7600.0, 7700.0, 7800.0, 7900.0,
                 8000.0, 8100.0, 8200.0, 8300.0, 8400.0, 8500.0, 8600.0, 8700.0, 8800.0, 8900.0, 9000.0, 9100.0, 9200.0,
                 9300.0, 9400.0, 9500.0, 9600.0, 9700.0, 9800.0, 9900.0)

        values = (0.99, 0.9801, 0.970299, 0.9605960100000001, 0.9509900499, 0.941480149401, 0.93206534790699,
        ...
        self.assertTrue( np.sum( ( np.array(results[0][0]) - np.array(times) )**2 ) < 0.00000001, "times of range" )
        self.assertTrue( np.sum( ( np.array(results[0][1]) - np.array(values) )**2 ) < 0.00000001, "values of range" )


    # test connection
    def test_bad_property_error_reward_transmitter(self):
    ...
    def test_spore_connection_1(self):
        self.spore_connection_test(1.0, 50, 50, 10000)
