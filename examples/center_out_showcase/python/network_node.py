...
class NetworkNode(PyNestNode):
    def __init__(self):
        ...
        control_neurons = nest.Create("hidden_neuron", n_control_neurons)
        ...
        for i in range(n_max_connections_hidden_hidden):
            nrns = hidden_neurons + control_neurons
        ...
        nest.Connect( control_neurons, inhibitory_neurons, e_to_i_conspec, e_to_i_synspec )

        nest.Connect( inhibitory_neurons, hidden_neurons, i_to_e_conspec, i_to_e_synspec )
        nest.Connect( inhibitory_neurons, control_neurons, i_to_e_conspec, i_to_e_synspec )
        ...
        self._create_event_out_proxy(control_neurons, **music_network_node_activity_out_port)
