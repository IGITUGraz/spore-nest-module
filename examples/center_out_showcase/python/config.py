...
max_trial_duration = 10.0 # [s]
reward_duration = 0.3 # [s]
min_wait_duration = 0.5 # [s]
max_wait_duration = 1.0 # [s]
hold_goal_duration = 0.1 # [s]
...
weight_mean_i_to_e = -1.0
weight_std_i_to_e = 0.2

weight_mean_e_to_i = 0.5
weight_std_e_to_i = 0.1

n_max_connections_input_hidden = 10
n_max_connections_hidden_hidden = 10
p_connection_input_hidden = 0.5
p_connection_hidden_hidden = 0.5
...
inhibitory_neuron_properties = {
    "dead_time": s_to_ms(0.002),  # refractory time after spike
    "I_e": -3.0,  # membrane offset parameter
    "target_adaptation_speed": 0.0,  # adaptation speed of homestatic mechanism
    "c_1": 0.0,  # weight for linear part of firing probability
    "c_2": 1.0,  # weight for exponential part of firing probability
    "c_3": 1.0,  # temperature for exponential part of firing probability
    "with_reset": False  # don't reset membrane after spike
